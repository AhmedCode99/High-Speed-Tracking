...
def capture_frames(frame_count, template):
    """
    ...
    for _ in range(frame_count):
        ...
        del frame, result
    location_queue.put(None)  # Signal to the find thread that capturing is done
...
capture_thread = threading.Thread(target=capture_frames, args=(frame_count,template))
...
# Wait for threads to finish processing their queues
